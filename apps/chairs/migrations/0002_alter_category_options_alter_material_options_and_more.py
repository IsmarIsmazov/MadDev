...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='chair',
            name='pickup',
            field=models.BooleanField(verbose_name='Самовывоз'),
        ),
    ]
